<template>
	<v-layout align-space-around justify-space-around column text-xs-justify>
		<!-- Goal -->
		<v-flex>
			<h1 class="display-3 text-xs-center">Deploy with git</h1>In this blog post, I'm going to describe how I deploy my website via git, without a single additional command.
			When I push
		...
		<v-flex>
			...
			<ul>
				...
				<li>
					remember to make
					<code>{folder}/hooks/post-receive</code> executable (I forgot it so many times I put this in it's own step)
				</li>
		...
		<!-- Done! -->
		<v-flex>
			<h2 class="display-2 text-xs-center">Done!</h2>Nothing more. Enjoy your easy deploys!
