...
export default {
	...
	data: () => ({
		code0: require('@/assets/blog/mail-server/00.txt'),
		code1: require('@/assets/blog/mail-server/01.txt'),
		code2: require('@/assets/blog/mail-server/02.txt'),
		code3: require('@/assets/blog/mail-server/03.txt'),
		code4: require('@/assets/blog/mail-server/04.txt'),
		code5: require('@/assets/blog/mail-server/05.txt'),
		code6: require('@/assets/blog/mail-server/06.txt'),
		code7: require('@/assets/blog/mail-server/07.txt')
	})
}
</script>